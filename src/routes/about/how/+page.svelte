...
<article class="prose">
  ...
  <p>A species page is assembled from public sources, each named on the page where its data appears, with the licence it came under. The name and its synonyms, family and order come from the <b>GBIF Backbone Taxonomy</b>; a name the backbone holds as a synonym is followed to the species it accepts, and the page says so. The native range comes from the <b>World Checklist of Vascular Plants</b> at Kew, which the app reads through GBIF; where WCVP has no entry the app falls back to national checklists and says so, at country level only. Occurrence records come from <b>GBIF</b>. Monthly climate normals come from <b>CHELSA V2.1</b> (1981–2010, 30 arc-second), packed to a 0.05° grid: day and night temperature, rainfall, solar radiation, relative humidity, vapour-pressure deficit and wind. Daily temperature extremes come from <b>NASA POWER</b> (1981 onward). Photographs come from <b>iNaturalist</b> research-grade observations and <b>Wikimedia Commons</b>, restricted to CC0, CC BY and CC BY-SA, and each carries its author and licence. The summary paragraph is <b>Wikipedia</b>'s, kept visibly separate and credited. Recent literature comes from <b>OpenAlex</b>.</p>
